...
text(650000,1850000,'Northern Fur Seals', cex = 2.7, col = 'darkorange1')
...
fixedBreaks = c(0, .1, .2, .4, .8, 3, max(mode_post, na.rm = TRUE) + 1e-10) - 1e-12
...
MCMC_CU_zmat = MCMCout$store_zmat
MCMC_CU_sigma = MCMCout$store_sigma
MCMC_CU_sigCAR = MCMCout$store_sigCAR
MCMC_CU_rho =	MCMCout$store_rho
MCMC_CU_beta0 =	MCMCout$store_beta0
MCMC_CU_accept_samp = MCMCout$accept_samp
MCMC_CU_accept_miss = MCMCout$accept_miss
MCMC_CU_accept_beta0 = MCMCout$accept_beta0
MCMC_CU_accept_sigma = MCMCout$accept_sigma
MCMC_CU_accept_sigCAR = MCMCout$accept_sigCAR
MCMC_CU_accept_rho = MCMCout$accept_rho
MCMC_CU_smoo =	smoo50
...
save(MCMC_CU_zmat, file = 'MCMC_CU_zmat.rda')
save(MCMC_CU_sigma, file = 'MCMC_CU_sigma.rda')
save(MCMC_CU_sigCAR, file = 'MCMC_CU_sigCAR.rda')
save(MCMC_CU_rho, file ='MCMC_CU_rho.rda')
save(MCMC_CU_beta0, file ='MCMC_CU_beta0.rda')
save(MCMC_CU_accept_samp, file = 'MCMC_CU_accept_samp.rda')
save(MCMC_CU_accept_miss, file = 'MCMC_CU_accept_miss.rda')
save(MCMC_CU_accept_beta0, file = 'MCMC_CU_accept_beta0.rda')
save(MCMC_CU_accept_sigma, file = 'MCMC_CU_accept_sigma.rda')
save(MCMC_CU_accept_sigCAR, file = 'MCMC_CU_accept_sigCAR.rda')
save(MCMC_CU_accept_rho, file = 'MCMC_CU_accept_rho.rda')
save(MCMC_CU_smoo, file = 'MCMC_CU_smoo.rda')
